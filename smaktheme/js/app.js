...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _anchor = __webpack_require__(4);
...
/***/ (function(module, exports) {
	...
	var anchor = function anchor() {
	  ...
	  //   setTimeout(function() {
	  //     $('a[data-target^="anchor"]').removeClass('active');
	  //     $('a[data-target^="anchor"]').parents('.header__list').find('li').eq(0).children('a').addClass('active');
	  //   }, 2000);
...
/***/ (function(module, exports) {
	...
	var tabs = function tabs() {
	  ...
	  $('.tabs-controls__link').on('click', function (e) {
	    ...
	    contentItem.filter('.tabs-list__item-' + itemPosition).add(item).addClass('active').siblings().removeClass('active');
	  });
	};
