...
/***/ (function(module, exports) {
	...
	exports.default = ["dev", "index.html", "test-animation.html", "test-slat.html"];
...
/***/ (function(module, exports) {
	...
	var tabs = function tabs() {
	  ...
	  $('.tab__link').on('click', function (e) {
	    ...
	    contentItem.filter('.tab__content-' + itemPosition).add(item).addClass('active').siblings().removeClass('active');
	  });
	};
